...
namespace Naz.Hastane.Data.Entities.Accounting
{
    ...
    {
        public virtual string FATURA_ID { get; set; } // FATURA_ID; length(8); 0 KEYDAT "00","FATNO" alanında son kesilen FaturaNo
        ...
        public virtual string FATURATIPI { get; set; } // FATURATIPI; length(1); 0 H: Hasta, K: Kurum, M:?
        public virtual string VEZNE { get; set; } // VEZNE; length(2); 0
        public virtual string FAK { get; set; } // FAK; length(2); 0 k: Hasta, A: Açık (Kurum), HA: Hasta Açık, N:, T:
        public virtual string ZHLKZ { get; set; } // ZHLKZ; length(2); 1 "N"
        public virtual string PSG { get; set; } // PSG; length(6); 1 Kurum Kodu
