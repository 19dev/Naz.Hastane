...
namespace Naz.Hastane.Data.Entities
{
    public class DoctorInvoiceDetail
    {
        ...
        /// AMBU
        /// </summary>
        public virtual char VisitType { get; set; } // AMBU; length(1); 0
        ...
        /// HKNR
        /// </summary>
        public virtual string PatientNo { get; set; } // HKNR; length(6); 0
        /// <summary>
        /// HSNR
        /// </summary>
        public virtual string PatientVisitNo { get; set; } // HSNR; length(3); 1
        /// <summary>
        /// HSIRANO
        /// </summary>
        public virtual double PatientVisitDetailNo { get; set; } // HSIRANO; length(8); 1
