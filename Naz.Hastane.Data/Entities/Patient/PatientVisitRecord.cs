...
namespace Naz.Hastane.Data.Entities
{
    public class PatientVisitRecord
    {
        ...
        public virtual string AMBU { get; set; } // AMBU; length(1); 0
        ...
        public virtual DateTime GELISTARIHI { get; set; } // GELISTARIHI; length(8); 0
        ...
        public virtual string SERNO { get; set; } // SERNO; length(5); 1
        ...
        public override bool Equals(object obj)
        {
            ...
            if (pv == null)
                return false;
            if (this.KNR == pv.KNR && this.SNR == pv.SNR && this.GELISTARIHI == pv.GELISTARIHI)
                return true;
            else
                return false;
        }
        ...
        public override int GetHashCode()
        {
            ...
            hash += this.GELISTARIHI.GetHashCode();
