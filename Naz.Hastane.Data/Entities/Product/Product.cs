...
namespace Naz.Hastane.Data.Entities
{
    public class Product
    {
        ...
        public virtual string HREFAKAT { get; set; } // HREFAKAT; length(1); 0
        public virtual string IKINCIHIZ { get; set; } // IKINCIHIZ; length(1); 1
        public virtual double KDV { get; set; } // KDV; length(8); 0
        public virtual string KHIZMET { get; set; } // KHIZMET; length(1); 1
        public virtual string KKODU { get; set; } // KKODU; length(20); 1
        ...
        public virtual string MBASLIK { get; set; } // MBASLIK; length(2); 1
        ...
        public virtual string PAKETGRUBU { get; set; } // PAKETGRUBU; length(10); 1
        ...
        public virtual string YTKHIZMET { get; set; } // YTKHIZMET; length(1); 0

        public override bool Equals(object obj)
        {
            if (obj == null)
                return false;
            Product pv = obj as Product;
            if (pv == null)
                return false;
