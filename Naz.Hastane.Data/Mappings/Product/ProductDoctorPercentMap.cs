...
{
    public class ProductDoctorPercentMap : ClassMap<ProductDoctorPercent>
    {
        public ProductDoctorPercentMap()
        {
            Table("HIZMET_DR_ORAN");
            ...
            Map(x => x.ANAHIZ).Column("ANAHIZ").Length(50); //1
            Map(x => x.ANHIZ).Column("ANHIZ").Length(50); //1
            ...
            Map(x => x.CODE1).Column("CODE1").Length(50); //1
            ...
            Map(x => x.HKILIT).Column("HKILIT").Length(50); //1
            Map(x => x.HMALIYET).Column("HMALIYET").Length(8); //1
            Map(x => x.HREFAKAT).Column("HREFAKAT").Length(50); //0
            Map(x => x.IKINCIHIZ).Column("IKINCIHIZ").Length(50); //1
            Map(x => x.KDV).Column("KDV").Length(8); //0
            Map(x => x.KKODU).Column("KKODU").Length(50); //1
            ...
            Map(x => x.MEDGONDER).Column("MEDGONDER").Length(50); //1
            ...
            Map(x => x.PAKETGRUBU).Column("PAKETGRUBU").Length(50); //1
