...
namespace Naz.Hastane.Data.Mappings.SummaryReports
{
	public class OzetDoktorAnaIslemMap : ClassMap<OzetDoktorAnaIslem>
	{
		public OzetDoktorAnaIslemMap() 
		{
			Table("rtblOzetDoktorAnaIslem");
