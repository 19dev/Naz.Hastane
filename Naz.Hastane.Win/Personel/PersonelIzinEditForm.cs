...
{
    public partial class PersonelIzinEditForm : PersonelDetailIzinForm
    {
        public PersonelIzinEditForm()
        {
            InitializeComponent();
            LoadLookUps();
        ...
        protected override bool Save()
        {
            ...
            {
                SimpleMsgBoxForm.ShowMsgBox("Lütfen Tarihleri Kontrol Ediniz", "Personel İzni Kayıt Hatası", true);
                return false;
            }
            try
            {
                LookUpServices.SaveOrUpdate(Session, TheObject);
                SimpleMsgBoxForm.ShowMsgBox("Personel İzni Kayıt Edilmiştir", "Personel İzni Kayıt Onayı");
                return true;
            }
            catch (Exception error)
            {
                SimpleMsgBoxForm.ShowMsgBox("Personel İzni Kayıt Edilemedi:" + error.Message, "Personel İzni Kayıt Hatası", true);
                return false;
            }
    ...
    public class PersonelDetailIzinForm : PersonelDetailEditForm<PersonelIzin> { }
}