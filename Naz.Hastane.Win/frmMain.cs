...
namespace Naz.Hastane.Win {
    public partial class frmMain : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        private void AttachMDIChildButtons()
        {
            ...
            iPersonelAra.ItemClick += (o, args) => ShowNewDocument<SearchPersonelForm>();
            ...
            iAmeliyatListesi.ItemClick += (o, args) => ShowNewDocument<AmeliyatListesiForm>();
            iSearchPatientArchive.ItemClick += (o, args) => ShowNewDocument<SearchPatientArchiveForm>();
        }
        ...
        private void ReportExportToPdf<T>(string aPath) where T : DevExpress.XtraReports.UI.XtraReport, new()
        {
            ...
            T report = new T();
            report.Parameters[0].Value = "AÐUSTOS 2011";
